...
# 네 CSV 파일 경로로 수정
CSV_PATH = Path(r"C:\Users\sec\OneDrive\바탕 화면\SK쉴더스\analyzer\UNSW_NB15_training-set.csv")
OUT_PATH = Path(r"C:\Users\sec\OneDrive\바탕 화면\SK쉴더스\analyzer\models/benign_stats.json")
